...
std::string commander::exec(const char* cmd)
{
...
std::string commander::exec(const std::string& cmd)
{
	input = cmd;
	check_special_cases_and_execute();
	return output;
...
void commander::extract_elements(std::string& inputStr, std::vector<std::string>& result)
{
...
void commander::check_special_cases_and_execute()
{
...
std::string commander::execute(const char* cmd) {
